...
-- =====================================================
-- KANUX: Correção Completa de Permissões v2
...
-- 3) Funções auxiliares (recriar para garantir)
...
-- 13) Políticas para ticket_comments
CREATE POLICY "ticket_comments_select" ON public.ticket_comments
  ...
  USING (
    ...
    OR EXISTS (
      ...
      AND (public.is_super_admin() OR t.company_id = ANY(public.get_my_company_ids()))
    )
  );
...
-- 16) Permissões para service_role (acesso total)
...
-- 17) Permissões padrão para futuras tabelas
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO authenticated;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT EXECUTE ON FUNCTIONS TO authenticated;

-- =====================================================
-- FIM - Permissões corrigidas!
-- =====================================================
